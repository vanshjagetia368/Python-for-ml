...
#Example 8:
#In this example, we will go on advancing and using all the statements that we have learned in this chapter to determine if a person is eligible for a loan based on their age, income, credit score, and employment status.
...
#This will include nested if statements elif staments else statements and all logical operators like the and, or, not to create a comprehensive eligibility check for health insurance plans.
